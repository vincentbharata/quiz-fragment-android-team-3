...
class Question3Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        radioGroup = view.findViewById(R.id.radio_group_q3)
        btnNext = view.findViewById(R.id.btn_next_q3)
        ...
        btnNext.setOnClickListener {
            ...
            (activity as MainActivity).saveAnswer(3, selectedAnswer)
            (activity as MainActivity).loadFragment(Question4Fragment())
        }
